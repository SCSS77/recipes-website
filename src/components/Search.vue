<template>
  <section class="search-section">
    <div class="container">
      <h1 class="search-section__title">Find Your Recipe</h1>
      <h2 class="search-section__subtitle">Delicious and Healthy Recipes</h2>
      <div class="search-section__search-box">
        <div class="search-section__search-input">
          <input class="search-section__input" v-model="query" placeholder="Search recipe..." />
          <button class="search-section__button" @click="searchRecipes">
      ...
      <img src="@/assets/images/bg-home.png" alt="Recipe Image" class="search-section__search-bg-image">
    </div>
  </section>
</template>
